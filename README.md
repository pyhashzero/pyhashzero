...
[![Documentation Status](https://readthedocs.org/projects/pyhashzero/badge/?version=latest)](https://pyhashzero.readthedocs.io/en/latest/?badge=latest)
[![PyPI version](https://badge.fury.io/py/pyhashzero.svg)](https://badge.fury.io/py/pyhashzero)
[![Build Status](https://travis-ci.com/pyhashzero/pyhashzero.svg?branch=master)](https://travis-ci.com/pyhashzero/pyhashzero)
[![Coverage Status](https://coveralls.io/repos/github/pyhashzero/pyhashzero/badge.svg)](https://coveralls.io/github/pyhashzero/pyhashzero)
[![License](https://img.shields.io/github/license/pyhashzero/pyhashzero)](https://github.com/pyhashzero/pyhashzero/blob/main/LICENSE)
[![Pylint](https://github.com/pyhashzero/pyhashzero/actions/workflows/pylint.yml/badge.svg)](https://github.com/pyhashzero/pyhashzero/actions/workflows/pylint.yml)
...
You can find more information in the [doc](https://pyhashzero.readthedocs.io/en/latest/).

## Installation

- Install pyhashzero from Pypi (recommended):

```
pip install pyhashzero
```

Install from Github source:

```
git clone https://github.com/pyhashzero/pyhashzero.git
cd pyhashzero
