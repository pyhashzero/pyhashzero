...
class CoreEnv(CoreObject, gym.Env):
    ...
    def step(self, action):
        ...
        # Arguments
            action (abstract): An action provided by the environment.

        # Returns
            observation (abstract): Agent's observation of the current environment.
...
class CoreModel(CoreObject):
    ...
    def predict(self):
        ...
        # Arguments
            state (abstract): Current state of the environment.
