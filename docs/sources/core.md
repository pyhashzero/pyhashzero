<span style="float:right;">[[source]](https://github.com/pyhashzero/pyhashzero/blob/master/hz/ai/core.py#L8)</span>
### CoreBuffer

```python
hz.ai.core.CoreBuffer.hz.ai.core.CoreBuffer(values, batch_size)
```
...
<span style="float:right;">[[source]](https://github.com/pyhashzero/pyhashzero/blob/master/hz/ai/core.py#L35)</span>
### CoreMemory

```python
hz.ai.core.CoreMemory.hz.ai.core.CoreMemory(buffer, batch_size)
```
